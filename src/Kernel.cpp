...
void Kernel::loop() {
    ...
    robots.emplace_back(RodetasRobot(1, MindSet::SingleAttackerStrategy, new RobotStrategySingleAttack()));
    //robots.emplace_back(RodetasRobot(2, MindSet::SingleAttackerStrategy, new RobotStrategySingleAttack()));
