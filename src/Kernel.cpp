...
void Kernel::loop() {
    ...
    robots.emplace_back(RodetasRobot(0, MindSet::DefenderStrategyLeft, new RobotStrategyDefenderLeft()));
    robots.emplace_back(RodetasRobot(1, MindSet::DefenderStrategyRight, new RobotStrategyDefenderRight()));
