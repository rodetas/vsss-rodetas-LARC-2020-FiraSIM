...
void Kernel::loop() {
    ...
    robots.emplace_back(RodetasRobot(0, MindSet::CenterAttackerStrategy, new RobotStrategyCenterAttack()));
    robots.emplace_back(RodetasRobot(1, MindSet::SideAttackerStrategy, new RobotStrategySideAttack()));
